...
const mySum = addTwoNumbers(23, 17) // this store the results and this way is the best way to use the function

console.log(mySum) //

// real world thype of example

function calculateSalesTax(subtotal, taxRate) {
const salesTax = (subtotal * taxRate).toFixed(2)
return salesTax 
}    // this will actually work in the reall world